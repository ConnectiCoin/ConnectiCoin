ConnectiCoin Core version *0.15.1* is now available from:

  <https://download.connecticoin.org/connecticoin-0.15.1/>
...
A number of changes to the way ConnectiCoin Core deals with peer connections and invalid blocks
