...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s connecticoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  connecticoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded connecticoin transaction") + "\n" +
              "  connecticoin-tx [options] -create [commands]   " + _("Create hex-encoded connecticoin transaction") + "\n" +
              "\n";
